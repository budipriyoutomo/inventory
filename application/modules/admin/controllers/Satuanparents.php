...
class SatuanParents extends Admin_Base_Controller
{
    ...
    {
        redirect('admin/satuanparents/all_satuanparents/');
    }

    public function all_satuanparents()
    {
        try {

            // Grocery Outlets getGroceryCRUD( $TableName, $Subject, $PageTitle, $Breadcrumbs )
            $crud = $this->getGroceryCRUD('tsatuanparent', 'SatuanParent', 'All Satuan Parent', 'Manage All Satuan Parent');

            // data Grid view fields
            $crud->columns('id', 'nama', 'rumus');
            ...
            // Insert form
            $crud->add_fields('id', 'nama','rumus');

            // Update form
            $crud->edit_fields('id', 'nama','rumus');
            ...
            // Required fields
            $crud->required_fields('id', 'nama','rumus');

            // Rename field level
            $crud->display_as('id', ' ID Satuan Parent')
                ->display_as('nama', ' Nama Satuan Parent')
                ->display_as('rumus', ' Rumus');
            ...
            $output = $crud->render();
            $this->load->view('admin/satuanparent/v_satuanparents', (array) $output);
