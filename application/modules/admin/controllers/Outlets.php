...
class Outlets extends Admin_Base_Controller
{
    ...
    public function index()
    {
        ...
        redirect('admin/outlets/all_outlets/');
    }
    ...
    public function all_outlets()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('toutlet', 'Outlets', 'All Outlets', 'Manage All Outlets');

            // data Grid view fields
            $crud->columns('idoutlet', 'namaoutlet', 'idgudang', 'idbrand','code');
            ...
            // Insert form
            $crud->add_fields('idoutlet', 'namaoutlet', 'idgudang', 'idbrand','code');

            // Update form
            $crud->edit_fields('idoutlet', 'namaoutlet', 'idgudang', 'idbrand','code');
            ...
            // Required fields
            $crud->required_fields('idoutlet', 'namaoutlet', 'idgudang', 'idbrand','code');
            
         
            // Rename field level
            $crud->display_as('idoutlet', ' ID Outlet')
                ->display_as('namaoutlet', ' Nama Outlet')
                ->display_as('idgudang', ' Gudang')
                ->display_as('idbrand', ' Brand')
                ->display_as('code', ' Outlet Code');

            $crud->set_relation('idgudang','tgudang','namagudang')
            ->set_relation('idbrand','tbrand','brand');
            ...
            $output = $crud->render();
            $this->load->view('admin/outlets/v_outlets', (array) $output);
