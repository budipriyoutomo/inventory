...
class StockBarangs extends Admin_Base_Controller
{
    ...
    {
        redirect('admin/stockbarangs/all_stockbarangs/');
    }

    public function all_stockbarangs()
    {
        try {

            // Grocery Outlets getGroceryCRUD( $TableName, $Subject, $PageTitle, $Breadcrumbs )
            $crud = $this->getGroceryCRUD('tstockbarang', 'Stock Barang', 'All Stock Barang', 'Manage All Stock Barang');

            // data Grid view fields
            $crud->columns('id', 'itemcode', 'barcode', 'qty', 'reorderqty', 'idgudang', 'expdate');
            ...
            // Insert form
            $crud->add_fields('id', 'itemcode', 'barcode', 'qty', 'reorderqty', 'idgudang', 'expdate');

            // Update form
            $crud->edit_fields('id', 'itemcode', 'barcode', 'qty', 'reorderqty', 'idgudang', 'expdate');
            ...
            $output = $crud->render();
            $this->load->view('admin/stockbarang/v_stockbarangs', (array) $output);
