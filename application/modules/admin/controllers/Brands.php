...
class Brands extends Admin_Base_Controller
{
    ...
    {
        redirect('admin/Brands/all_brands/');
    }
    ...
    public function all_brands()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('tbrand', 'Brands', 'All Brands', 'Manage All Brands');

            // data Grid view fields
            $crud->columns('idbrand', 'brand');
            ...
            // Insert form
            $crud->add_fields('idbrand', 'brand');

            // Update form
            $crud->edit_fields('idbrand', 'brand');
            ...
            // Required fields
            $crud->required_fields('idoutlet', 'namaoutlet', 'idgudang', 'idbrand');

            // Rename field level
            $crud->display_as('idbrand', ' ID Brand')
            ...
            $output = $crud->render();
            $this->load->view('admin/brands/v_brands', (array) $output);
