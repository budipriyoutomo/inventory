...
class Jeniss extends Admin_Base_Controller
{
    ...
    {
        redirect('admin/Jeniss/all_jeniss/');
    }

    public function all_jeniss()
    {
        try {

            // Grocery Outlets getGroceryCRUD( $TableName, $Subject, $PageTitle, $Breadcrumbs )
            $crud = $this->getGroceryCRUD('tjenis', 'Jenis', 'All Jenis', 'Manage All Jenis');

            // data Grid view fields
            $crud->columns('idjenis', 'namajenis');
            ...
            // Insert form
            $crud->add_fields('idjenis', 'namajenis');

            // Update form
            $crud->edit_fields('idjenis', 'namajenis');
            ...
            // Required fields
            $crud->required_fields('idjenis', 'namajenis');

            // Rename field level
            $crud->display_as('idjenis', ' ID Jenis')
                ->display_as('namajenis', ' Nama Jenis');
            ...
            $output = $crud->render();
            $this->load->view('admin/jenis/v_jeniss', (array) $output);
